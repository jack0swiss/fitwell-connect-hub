    ...
    <div className="min-h-screen bg-fitwell-dark text-white pb-20">
      ...
      <main className="p-4 max-w-2xl mx-auto flex items-center justify-center min-h-[70vh]">
        <div className="text-center">
          <h2 className="text-xl font-medium text-fitwell-purple mb-2">Workout Management</h2>
          <p className="text-muted-foreground">Create and assign workouts to your clients.</p>
        </div>
      </main>
